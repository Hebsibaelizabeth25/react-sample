...
function Rstudentform() {
  ...
  const handleSubmit = (e) => {
    ...
    const newDatas = { ...formData, id: newId };
  
    // Perform form submission with newDatas
    fetch('http://localhost:3000/students', {
      method: 'POST',
      headers: {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="form-container">
       ...
       <div>
         <label>
           Amount Paid<span className="mandatory">*</span>:
           <input
             type="text"
             name="amountPaid"
       ...
       <div>
         <label>
           Outstanding Amount<span className="mandatory">*</span>:
           <input
             type="text"
     ...
     {/* Popup to show after successful submission */}
     {showPopup && (
       <div className="popup">
